...
public class TestCategoryKidsWorld extends TestInit {

    @Test
    public void testCategoryKidsWorld() {
        ...
        sleep(2);
        moyoPageCategoryKidsWorld.getTopGoodsFirst().sendKeys(Keys.ENTER);
        sleep(2);
        ...
        moyoPageOrder.getFieldCity().sendKeys("Житомир\n");
        sleep(2);
