...
public class TestCategoryHomeEquipment extends TestInit {

    @Test
    public void testCategoryHomeEquipment() {
        ...
        sleep(2);
        moyoPageCategoryHomeEquipment.getTopGoodsFirst().sendKeys(Keys.ENTER);
        sleep(2);
        ...
        moyoPageOrder.getFieldCity().sendKeys("Суми\n");
        sleep(2);
